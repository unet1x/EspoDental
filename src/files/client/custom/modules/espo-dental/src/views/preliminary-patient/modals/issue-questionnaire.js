define('espo-dental:views/preliminary-patient/modals/issue-questionnaire', ['views/modal'], function (Dep) {

    return Dep.extend({

        templateContent:
            '<p>{{translate "Issue questionnaire confirm" category="messages" scope="PreliminaryPatient"}}</p>' +
        ...
        actionIssue: function () {
            ...
            Espo.Ajax.postRequest('PreliminaryPatient/action/issueQuestionnaire', {
                id: this.model.id,
                language: lang
