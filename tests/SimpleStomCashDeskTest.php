...
final class SimpleStomCashDeskTest extends TestCase
{
    ...
    public function testCashDeskWorkspaceStartsFromInvoicesAndShiftClosing(): void
    {
        ...
        $this->assertStringContainsString('getDoctorOptions', $service);
        $this->assertStringContainsString('pickSelectedInvoice', $service);
        $this->assertStringContainsString("'selectedInvoice'", $service);
        $this->assertStringContainsString("'doctorOptions'", $service);
        $this->assertStringContainsString("visit->get('doctorId')", $service);
        ...
        $this->assertStringContainsString('selectedInvoiceId', $controller);
        $this->assertStringContainsString('postActionCloseShift', $controller);
        $this->assertStringContainsString('CashDeskWorkspace', $dashlet);
        $this->assertStringContainsString('data-name="doctorId"', $dashlet);
        $this->assertStringContainsString('Выбранный счет', $dashlet);
        $this->assertStringContainsString('data-selected-invoice="true"', $dashlet);
        $this->assertStringContainsString('openPaymentWizard', $dashlet);
        $this->assertStringContainsString("Payment/action/accept", $dashlet);
